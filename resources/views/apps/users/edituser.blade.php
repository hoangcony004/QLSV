        ...
        <div class="row">
            <div class="col-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="name" value="{{ $user->name }}" id="floatingInput" placeholder="name@example.com" />
                    <label for="floatingInput">Họ và Tên</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="username" value="{{ $user->username }}" id="floatingInput" placeholder="name@example.com" />
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" name="phone_number" id="floatingInput" value="{{ $user->phone_number }}" placeholder="name@example.com" />
            ...
            <div class="col-6">
                ...
                <div class="form-floating">
                    <select class="form-select" id="floatingSelect" name="address" value="" aria-label="Floating label select example">
                        <!-- <option selected>{{ $user->address }}</option>
                        <option value="Hà Nội">Hà Nội</option>
                        <option value="TP.HCM">TP.HCM</option>
                        <option value="Đà Nẵng">Đà Nẵng</option> -->
                        @foreach ($provinces as $province)
                        <option value="{{ $province }}" {{ $user->address == $province ? 'selected' : '' }}>
                            {{ $province }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="row g-2">
                    <div class="col-md">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="image" value="{{ $user->image }}" id="floatingInputGrid" placeholder="name@example.com" />
